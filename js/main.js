...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const themeLabel = document.querySelector('label[for="flexSwitchCheckDefault"]');
  ...
  if (savedTheme === 'dark') {
    ...
    hero.style.backgroundImage = "url('media/images/hero-img2.png')";
  } else {
    document.body.classList.remove('DarkTheme');
    themeSwitch.checked = false;
    themeLabel.textContent = 'Dark';
    hero.style.backgroundImage = "url('media/images/hero-bg-image4.png')";
  }
